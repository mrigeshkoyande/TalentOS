  ...
  return (
    <AppShell>
      ...
      <div className="glass-card rounded-lg overflow-hidden border border-white/5 shadow-2xl">
        ...
        {/* Sticky Table Header */}
        <div className="hidden md:grid grid-cols-12 px-6 py-4 border-b border-white/5 bg-[#0b0c10]/40 sticky top-16 z-20 backdrop-blur-md">
          <div className="col-span-3 font-mono text-[9px] text-[#A1A1A1] uppercase tracking-widest">Candidate Profile</div>
          <div className="col-span-6 pl-6 font-mono text-[9px] text-[#A1A1A1] uppercase tracking-widest">Alignment Rationale</div>
          <div className="col-span-2 text-right font-mono text-[9px] text-[#A1A1A1] uppercase tracking-widest">Alignment Score</div>
          <div className="col-span-1 text-right font-mono text-[9px] text-[#A1A1A1] uppercase tracking-widest">Actions</div>
        </div>
                ...
                <div key={c.id} className="transition-all duration-300">
                  ...
                  >
                    ...
                    <div className="col-span-3 flex items-start gap-3.5">
                      <div className="shrink-0 mt-1">
                        ...
                        {c.isHiddenGem && (
                          <div className="flex items-center gap-1.5 mt-1 px-1.5 py-0.5 rounded-full bg-[#779165]/10 border border-[#779165]/20 w-fit">
                            ...
                            <span className="font-mono text-[7px] text-[#779165] uppercase tracking-wider font-semibold">
                              GEM
                            </span>
                          </div>
                        )}
                      ...
                      <div>
                        <p className="font-geist text-xs font-semibold text-[#F5F5F5] leading-tight">{c.name}</p>
                    ...
                    <div className="col-span-2 flex md:flex-col items-center md:items-end justify-between md:justify-start gap-1 w-full md:w-auto">
                      ...
                      <div className="text-right">
                        <span className="font-mono text-xs font-semibold text-[#779165] text-glow-green">
                          {c.matchScore.toFixed(1)}% Match
                        </span>
                        <span className="font-mono text-[9px] text-[#A1A1A1] block mt-0.5">
                    ...
                    <div className="col-span-1 flex justify-between items-center md:justify-end w-full md:w-auto">
                      ...
                      <button
                        ...
                        className={`font-mono text-[10px] uppercase tracking-widest py-1.5 px-3 rounded-md transition-colors ${
